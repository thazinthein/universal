...
<div id="order_review">
	...
	<div class="form-row place-order">
			...
			<?php
			$order_button_text = apply_filters( 'woocommerce_order_button_text', __( 'Submit', 'woocommerce' ) );

			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="btn btn-3 btn-3a update-btn" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
