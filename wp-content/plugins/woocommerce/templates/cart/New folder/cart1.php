...
<div style="border: 1px solid #f7f6f4;background: #f7f6f4;">
<form action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post" style="amargin-right:20px;">
...
<table class="shop_table cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-name"><?php _e( 'Recruitment', 'woocommerce' ); ?></th>
	...
	<tbody>
		...
		<tr height="70px">
			...
			<td colspan="4" class="actions">
				...
				<!-- <input type="submit" class="btc btn-2e updatecart" name="update_cart" value="<?php _e( 'Update Quote', 'woocommerce' ); ?>" /> -->
				<input type="submit" class="btn btn-3 btn-3a update-btn cart-btn" name="proceed" value="<?php _e( 'Proceed to Send quotation &rarr;', 'woocommerce' ); ?>" />
