	...
	<tbody>
		...
		<tr height="70px">
			<td colspan="6" class="actions">
				...
				<input type="submit" class="update-btn" name="update_cart" value="<?php _e( 'Update Enquiry', 'woocommerce' ); ?>" /> <input type="submit" class="checkout-btn checkout-button " name="proceed" value="<?php _e( 'Proceed to Submit &rarr;', 'woocommerce' ); ?>" />
