	...
	public static function register_post_types() {
		...
		register_post_type( 'product',
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							'name'               => __( 'Projects', 'woocommerce' ),
							'singular_name'      => __( 'Projects', 'woocommerce' ),
							'menu_name'          => _x( 'Projects', 'Admin menu name', 'woocommerce' ),
							'add_new'            => __( 'Add Projects', 'woocommerce' ),
							'add_new_item'       => __( 'Add New Projects', 'woocommerce' ),
							'edit'               => __( 'Edit', 'woocommerce' ),
							'edit_item'          => __( 'Edit Projects', 'woocommerce' ),
							'new_item'           => __( 'New Projects', 'woocommerce' ),
							'view'               => __( 'View Projects', 'woocommerce' ),
							'view_item'          => __( 'View Projects', 'woocommerce' ),
							'search_items'       => __( 'Search Projects', 'woocommerce' ),
							'not_found'          => __( 'No Projects found', 'woocommerce' ),
							'not_found_in_trash' => __( 'No Projects found in trash', 'woocommerce' ),
							'parent'             => __( 'Parent Projects', 'woocommerce' )
						),
		...
		wc_register_order_type(
			...
			apply_filters( 'woocommerce_register_post_type_shop_order',
				array(
					'labels'              => array(
							'name'               => __( 'Enquiry', 'woocommerce' ),
							'singular_name'      => __( 'Enquiry', 'woocommerce' ),
