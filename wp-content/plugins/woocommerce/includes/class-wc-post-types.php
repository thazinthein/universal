			...
			apply_filters( 'woocommerce_register_post_type_product',
				array(
					'labels'              => array(
							...
							'singular_name'      => __( 'Products', 'woocommerce' ),
							'menu_name'          => _x( 'Products', 'Admin menu name', 'woocommerce' ),
							'add_new'            => __( 'Add Products', 'woocommerce' ),
							'add_new_item'       => __( 'Add New Products', 'woocommerce' ),
							'edit'               => __( 'Edit', 'woocommerce' ),
							'edit_item'          => __( 'Edit Products', 'woocommerce' ),
							'new_item'           => __( 'New Products', 'woocommerce' ),
							'view'               => __( 'View Products', 'woocommerce' ),
							'view_item'          => __( 'View Products', 'woocommerce' ),
