		...
		<div class="panel-wrap woocommerce">
			...
			<div id="order_data" class="panel">
				...
				<div class="order_data_column_container">
					...
					<div class="order_data_column">
						<h4><?php _e( 'Customer Address', 'woocommerce' ); ?> <a class="edit_address" href="#"><img src="<?php echo WC()->plugin_url(); ?>/assets/images/icons/edit.png" alt="<?php _e( 'Edit', 'woocommerce' ); ?>" width="14" /></a></h4>
						<?php
							// Display values
