...
class Mega_Menu_Walker extends Walker_Nav_Menu {
	...
	function start_lvl( &$output, $depth = 0, $args = array() ) {
		...
		$output .= "\n$indent<ul style='width: 1723px; display: none;z-index:9999;left:-620px;padding-left:9em;margin-left:10em;padding-top:0px;padding-bottom:0px;' class=\"mega-sub-menu\">\n";
	}
